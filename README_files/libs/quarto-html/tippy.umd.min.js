!(function (e, t) {
  ...
  var x = { isTouch: !1 },
    C = 0;
  function T() {
    x.isTouch || ((x.isTouch = !0), window.performance && document.addEventListener("mousemove", A));
  }
  function A() {
  ...
  function V(e) {
    var t = d();
    return (
      !0 === e ? (t.className = "tippy-arrow") : ((t.className = "tippy-svg-arrow"), v(e) ? t.appendChild(e) : M(t, e)),
      t
    );
  }
  function I(e, t) {
    v(t.content)
      ...
      : "function" != typeof t.content && (t.allowHTML ? M(e, t.content) : (e.textContent = t.content));
  }
  function S(e) {
  ...
  function _(o, s) {
    var v,
      ...
      $ = {
        ...
        setProps: function (e) {
          ...
          (($.props = n),
            he(),
            t.interactiveDebounce !== n.interactiveDebounce && (ce(), (W = a(we, n.interactiveDebounce))));
        ...
        show: function () {
          ...
          ((A = function () {
            ...
            if ($.state.isVisible && !_) {
              if (
                ((_ = !0), z.offsetHeight, (z.style.transition = $.props.moveTransition), ee() && $.props.animation)
              ) {
                var t = re(),
                  n = t.box,
                  r = t.content;
    ...
    var q = M.render($),
      z = q.popper,
      J = q.onUpdate;
    (z.setAttribute("data-tippy-root", ""), (z.id = "tippy-" + $.id), ($.popper = z), (o._tippy = $), (z._tippy = $));
    ...
    return (
      ...
      z.addEventListener("mouseleave", function () {
        $.props.interactive && $.props.trigger.indexOf("mouseenter") >= 0 && ne().addEventListener("mousemove", W);
      }),
      $
    );
    function Q() {
        ...
        y = F(
          ...
          Object.assign({}, s(t, ["overrides"]), {
            ...
            popperOptions: Object.assign({}, t.popperOptions, {
              modifiers: [].concat((null == (n = t.popperOptions) ? void 0 : n.modifiers) || [], [W]),
            }),
          }),
        ),
        w = y.show;
